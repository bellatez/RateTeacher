      ...
      <div class="col-md-12">
        ...
        <div class="owl-carousel owl-theme home-slider">
            @foreach($blogs as $blog)
              <div>
                <a href="/blog-single" class="a-block d-flex align-items-center height-lg" style="background-image: url('images/img_1.jpg'); ">
                  <div class="text half-to-full">
                    <span class="category mb-5">Food</span>
                    <div class="post-meta">
                      
                      <span class="author mr-2"><img src="images/person_1.jpg" alt="Colorlib"> Colorlib</span>&bullet;
                      <span class="mr-2">{{$blog->created_at->toFormattedDateString()}} </span> &bullet;
        ...
        <div class="row">
          <div class="col-md-6">
            <a href="/blog-single" class="blog-entry element-animate" data-animate-effect="fadeIn">
              <img src="{{asset('images/img_1')}}" alt="Image placeholder">
